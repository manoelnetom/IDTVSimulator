...
public final class StillPicture extends Component{
    String picturePath;

    public StillPicture(String path)
    {
    	this.picturePath = path;
    	setUIID("StillPicture");
    }

    public void addFocusListener(FocusListener l) {
    }

    //StilPicture component does not support animation
    ...
    //StillPicture does not support focus functionalities
