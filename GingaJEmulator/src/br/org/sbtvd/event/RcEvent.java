 ...
 * @statuscode 4
 */
public class RcEvent extends KeyEvent{
    ...
    public RcEvent(Component source, int id, long when, int modifiers, int keyCode){
	    super(source, id, when, modifiers, keyCode, (char)keyCode);
    }
   
    public RcEvent(Component source, int id, long when, int modifiers, int keyCode, char keyChar){
