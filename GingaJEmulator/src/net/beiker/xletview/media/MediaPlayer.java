...
//        setMedia(media);
    ...
    /**
     *
     * @param media the media to be played This method does nothing if
     * @param media is already playing
     */
    void setMedia(Media media) {
        if (this.media != media) {
            ...
            if (media.getType() == Media.TYPE_IMAGE) {
                ...
                //createImagePlayer( media.getURL() );
                createVLCPlayer(ChannelManager.getInstance().getCurrentChannel());
    ...
    private void createVLCPlayer(int channel) {
        player = new VLCSPlayer(channel);
    ...
    private void createVideoPlayer(URL videoUrl) {
        if (videoUrl != null) {
            ...
            try {
                ...
                // Jeff:: Manager.setHint(Manager.LIGHTWEIGHT_RENDERER, new Boolean(true));
