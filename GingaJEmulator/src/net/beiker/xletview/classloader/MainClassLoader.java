...
public class MainClassLoader extends URLClassLoader {
    ...
    private URL[] addUrls() {
        ...
        paths.add("lib/javatv.jar");
        paths.add("lib/cake.jar");
        paths.add("lib/metouia.jar");
        paths.add("lib/javassist.jar");
        paths.add("lib/nanoxml-2.2.3.jar");
        paths.add("lib/jregex.jar");
        paths.add("lib/jmf/jmf.jar");
