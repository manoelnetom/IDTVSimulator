 ...
 * </PRE>
 * 
 * A MatteException is thrown whenever an application is unable for some reason
 * to realize a desired matte association to a graphical element.
 * 
 * <A HREF="../../../../serialized-form.html#com.sun.dtv.ui.MatteException">Serialized Form</A></DL>
 * <HR>
 * 
 * 
 * <!-- ======== CONSTRUCTOR SUMMARY ======== -->
 ...
 * <TD><CODE><B><A HREF="../../../../com/sun/dtv/ui/MatteException.html#MatteException()">MatteException</A></B>()</CODE>
 * 
 * <BR>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Constructs a MatteException object.</TD>
 * </TR>
 * <TR BGCOLOR="white" CLASS="TableRowColor">
 * <TD><CODE><B><A HREF="../../../../com/sun/dtv/ui/MatteException.html#MatteException(java.lang.String)">MatteException</A></B>(<A HREF="http://java.sun.com/javame/reference/apis/jsr219/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</A>&nbsp;message)</CODE>
 * 
 * <BR>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Constructs a MatteException object.</TD>
 * </TR>
 ...
 * </TABLE>
 * 
 * <A NAME="MatteException()"><!-- --></A><H3>
 * MatteException</H3>
 * <PRE>
 * public <B>MatteException</B>()</PRE>
 * <DD>Constructs a MatteException object.
 * <HR>
 * 
 * <A NAME="MatteException(java.lang.String)"><!-- --></A><H3>
 * MatteException</H3>
 * <PRE>
 * public <B>MatteException</B>(<A HREF="http://java.sun.com/javame/reference/apis/jsr219/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</A>&nbsp;message)</PRE>
 * <DD>Constructs a MatteException object.
 * <!-- ========= END OF CLASS DATA ========= -->
 * <HR>
 * 
 ...
 * <TD BGCOLOR="#EEEEFF" CLASS="NavBarCell1">    <A HREF="class-use/MatteException.html"><FONT CLASS="NavBarFont1"><B>Use</B></FONT></A>&nbsp;</TD>
 ...
 * &nbsp;<A HREF="../../../../com/sun/dtv/ui/MatteEnabled.html" title="interface in com.sun.dtv.ui"><B>PREV CLASS</B></A>&nbsp;
 * &nbsp;<A HREF="../../../../com/sun/dtv/ui/Mouse.html" title="class in com.sun.dtv.ui"><B>NEXT CLASS</B></A></FONT></TD>
 * <TD BGCOLOR="white" CLASS="NavBarCell2"><FONT SIZE="-2">
 * <A HREF="../../../../index.html?com/sun/dtv/ui/MatteException.html" target="_top"><B>FRAMES</B></A>  &nbsp;
 * &nbsp;<A HREF="MatteException.html" target="_top"><B>NO FRAMES</B></A>  &nbsp;
...
public class MatteException extends Exception
{
	 ...
	 *
	 * 
	 * @param message - a message provided to the exception
	 */
