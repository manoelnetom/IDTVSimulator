 ...
 *
 */
public abstract class UserInputDevice extends Object
{
	/**
	 * It should not be possible to create instances of subclasses of
	 * <A HREF="../../../../com/sun/dtv/ui/UserInputDevice.html" title="class in com.sun.dtv.ui"><CODE>UserInputDevice</CODE></A> by everybody, they are bound to a
	...
	{
		//TODO implement UserInputDevice
	}

	/**
	 * Returns the Input event which will be produced by an implementing
	 * class for the specified code.
	 *
	 * 
