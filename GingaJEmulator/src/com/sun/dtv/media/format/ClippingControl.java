 ...
 * 
 */
public interface ClippingControl extends Control
{
	 ...
	 * @see setRegion(com.sun.dtv.lwuit.geom.Rectangle)
	 */
	Rectangle getRegion();

	/**
	 * Sets the Rectangle region to which the video will be clipped.
	 * The <code>clippingRect</code> is a request from the application
	 * the terminal has to set the clipping
	 * rectangle to the closest technical possible value.
	 *
	 * 
	 * @param clippingRect - the clipping rectangle region
	 * @return the selected clipping rectangle by the terminal. In case the terminal supports no clipping null is returned.
	 * @see getRegion()
	 */
