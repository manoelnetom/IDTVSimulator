 ...
 * 
 */
public class BroadcastFileEvent extends EventObject
{
	...
	/**
	 * Reports the <code>BroadcastFile</code> whose contents have changed.
	 *
	 * 
	 * 
	 * @return The BroadcastFile whose contents have changed.
	 */
