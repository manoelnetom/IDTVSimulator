...
public interface CallbackHandler
{
	 ...
	 * @throws IOException - if an input or output error occurs when retrieving the password
	 * @throws UnsupportedCallbackException - if one of the callbacks in the array is not supported by the handler
	 */
