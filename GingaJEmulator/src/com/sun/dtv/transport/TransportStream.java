 ...
 * 
 */
public class TransportStream extends Object
{
	 ...
	 * 
	 * 
	 * @return the id of the transport stream
	 */
	public int getId()
	{
		return this.id;
	 ...
	 *
	 * 
	 * @param id - id for the requested Service object
	 * @return Service object for specified service id. Returns null if no such service exists.
	 */
	 ...
	 * 
	 * 
	 * @return array of the contained Service objects
	 */
