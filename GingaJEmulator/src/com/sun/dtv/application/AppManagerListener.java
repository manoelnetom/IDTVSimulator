...
public interface AppManagerListener
{
	 ...
	 *
	 * 
	 * @param app - the application that has been removed.
	 */
	 ...
	 *
	 * 
	 * @param app - the Application with the changed attributes.
	 */
	void appChanged( Application app);

	/**
	 * Called when the entire list of available applications changes.
	 * Individual added/removed/changed listeners will not be called.
	 *
	 * 
	 */
	void appRefresh();
