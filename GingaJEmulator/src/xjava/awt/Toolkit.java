...
public class Toolkit {
    ...
    public Image getImage(String filename) {
        ...
        return realToolkit.getImage(xjava.io.FileInputStream.getBaseDirectory(new File(filename)));
    }
    ...
    public Image createImage(String filename) {
        return realToolkit.createImage(xjava.io.FileInputStream.getBaseDirectory(new File(filename)));
