...
public class EncapDatagramSocketImpl extends DatagramSocketImpl implements SourceTransferHandler {
    ...
    private boolean mcast;
		...
		// Jeff::
		public void leaveGroup(java.net.SocketAddress sa, java.net.NetworkInterface ni) {
		}

		// Jeff::
		public void joinGroup(java.net.SocketAddress sa, java.net.NetworkInterface ni) {
		}

		// Jeff::
		public int peekData(java.net.DatagramPacket dp) {
			return 0;
		}
	...
	if ( loc != null) { //just to make sure
	    ...
	    source.connect();
	    inStream = null; // Jeff::(PushSourceStream2) source.getStreams()[0];
	    ((EncapIPStream)inStream).setTransferHandler(this); 
